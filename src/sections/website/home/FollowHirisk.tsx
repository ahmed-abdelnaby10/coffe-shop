...
export default function FollowHirisk() {
    return (
        <Container className='flex flex-col items-center justify-start gap-10'>
            ...
            <div className='grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-5 justify-items-center justify-center'>
                <div className='relative w-full max-lg:h-44 flex items-center justify-start rounded-xl overflow-hidden'>
                    <Image
                        src={facebookBanner.src}
                        alt='facebookbanner'
                        width={9999}
                        height={9999}
                ...
                <div className='relative max-lg:h-44 bg-mainColor w-full flex items-center justify-start rounded-xl overflow-hidden'>
                    <Image
                        src={phoneBanner.src}
                        alt='phoneBanner'
                        width={9999}
